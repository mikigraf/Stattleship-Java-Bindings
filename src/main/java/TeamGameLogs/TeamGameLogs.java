 ...
 */
public class TeamGameLogs implements Parameters<TeamGameLogs> {
    private static String endpoint = "/";
    private Map<FeatsParameters, String> parameters;
    private String currentRequest;

    public TeamGameLogs(SportLeague league){
        endpoint = league.toString() + "team_game_logs";
        currentRequest = endpoint;
        parameters = new HashMap<FeatsParameters, String>();
    }

    public TeamGameLogs(Map<FeatsParameters,String> parameters){
        currentRequest = endpoint;
    ...
    public TeamGameLogs build(){
        currentRequest = endpoint;
        return this;
    }

    public TeamGameLogs perPage(int num){
